...
async def run_agent():
    ...
    # 1、非流式处理查询
    agent_response = await agent.ainvoke({"messages": [HumanMessage(content="调用工具查询下这个118.79815,32.01112经纬度对应的地方是哪里")]}, config)
    ...
    #         input={"messages": [HumanMessage(content="调用工具查询下这个118.79815,32.01112经纬度对应的地方是哪里")]},
    #         config=config,
