...
复诊管理智能体是专门处理复诊预约、查询、更新和提醒管理的智能体，通过调用Java微服务提供的HTTP API接口实现业务功能。复诊管理智能体作为路由系统中的专门智能体之一，通过路由智能体路由调用。
...
| APP-004 | 复诊管理智能体 | 提醒管理 | 设置、查询和管理复诊提醒 |
...
<table>
    <th colspan="4">功能描述：<span>设置、查询和管理复诊提醒</span></th>
    <tr>
        <td colspan="4"> JIRA链接: <span>APP-004</span></td>
    </tr>
    <tr>
        <td>工具名称</td><td colspan="3">set_reminder</td>
    </tr>
    <tr>
        <td colspan="4"> 入参</td>
    </tr>
    ...
    <tr>
        <td>reminder_time</td><td>datetime</td><td>Y</td><td>提醒时间</td>
    </tr>
    <tr>
        <td>user_id</td><td>str</td><td>Y</td><td>用户ID</td>
    </tr>
    ...
    <tr>
        <td>result</td><td>str</td><td colspan="2">设置结果消息</td>
    </tr>
</table>
